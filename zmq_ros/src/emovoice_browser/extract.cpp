...
extern void command(speech_msgs::Extract ext_msg,int okao_id,string name);

void extract(speech_msgs::SpeechConstPtr speech,int okao_id,string name){
    int i = 0;
    int d = 0;
    int no = 0;
    int b = 0;
