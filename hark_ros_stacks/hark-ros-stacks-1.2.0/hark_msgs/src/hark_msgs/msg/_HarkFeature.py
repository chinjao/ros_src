"""autogenerated by genpy from hark_msgs/HarkFeature.msg. Do not edit."""
import sys
...
class HarkFeature(genpy.Message):
  _md5sum = "e61d4af0b817ab09bd341b909e7c1ed9"
  _type = "hark_msgs/HarkFeature"
...
"""
  ...
  _slot_types = ['std_msgs/Header','int32','int32','hark_msgs/HarkFeatureVal[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(HarkFeature, self).__init__(*args, **kwds)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = hark_msgs.msg.HarkFeatureVal()
        _x = val1
        start = end
        end += 12
