"""autogenerated by genpy from hark_msgs/HarkSource.msg. Do not edit."""
import sys
...
class HarkSource(genpy.Message):
  _md5sum = "21a049a3207fea2bd7dd556299ef6e38"
  _type = "hark_msgs/HarkSource"
...
"""
  ...
  _slot_types = ['std_msgs/Header','int32','int32','hark_msgs/HarkSourceVal[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(HarkSource, self).__init__(*args, **kwds)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = hark_msgs.msg.HarkSourceVal()
        _x = val1
        start = end
        end += 24
