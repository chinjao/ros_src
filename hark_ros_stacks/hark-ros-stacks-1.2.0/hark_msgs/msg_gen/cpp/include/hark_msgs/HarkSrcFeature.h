/* Auto-generated by genmsg_cpp for file /home/yhirai/catkin_ws/src/hark_ros_stacks/hark-ros-stacks-1.2.0/hark_msgs/msg/HarkSrcFeature.msg */
...
struct HarkSrcFeature_ {
  ...
  std::vector< ::hark_msgs::HarkSrcFeatureVal_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::hark_msgs::HarkSrcFeatureVal_<ContainerAllocator> >::other >  src;
...
{
template<class ContainerAllocator> struct IsMessage< ::hark_msgs::HarkSrcFeature_<ContainerAllocator> > : public TrueType {};
template<class ContainerAllocator> struct IsMessage< ::hark_msgs::HarkSrcFeature_<ContainerAllocator>  const> : public TrueType {};
template<class ContainerAllocator>
struct MD5Sum< ::hark_msgs::HarkSrcFeature_<ContainerAllocator> > {
  static const char* value() 
  {
    return "dca74b545a628fff78205f5b2085d4ef";
  }

  static const char* value(const  ::hark_msgs::HarkSrcFeature_<ContainerAllocator> &) { return value(); } 
  static const uint64_t static_value1 = 0xdca74b545a628fffULL;
  static const uint64_t static_value2 = 0x78205f5b2085d4efULL;
};
...
template<class ContainerAllocator> struct HasHeader< ::hark_msgs::HarkSrcFeature_<ContainerAllocator> > : public TrueType {};
template<class ContainerAllocator> struct HasHeader< const ::hark_msgs::HarkSrcFeature_<ContainerAllocator> > : public TrueType {};
} // namespace message_traits
} // namespace ros
