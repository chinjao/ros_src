"""autogenerated by genpy from fdopencv_msgs/ImageMapVal.msg. Do not edit."""
import sys
...
class ImageMapVal(genpy.Message):
  _md5sum = "ec273785f6797c77d37579f49be2dd3b"
  _type = "fdopencv_msgs/ImageMapVal"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ImageMapVal, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_i3I.pack(_x.id, _x.img.header.seq, _x.img.header.stamp.secs, _x.img.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.id, _x.img.header.seq, _x.img.header.stamp.secs, _x.img.header.stamp.nsecs,) = _struct_i3I.unpack(str[start:end])
      start = end
      end += 4
