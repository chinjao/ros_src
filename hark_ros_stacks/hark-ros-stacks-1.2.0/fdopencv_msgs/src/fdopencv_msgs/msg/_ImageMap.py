"""autogenerated by genpy from fdopencv_msgs/ImageMap.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct

import fdopencv_msgs.msg
import sensor_msgs.msg
import std_msgs.msg

class ImageMap(genpy.Message):
  _md5sum = "5b7f3665db92b0de9828f481864a0838"
  _type = "fdopencv_msgs/ImageMap"
...
"""
  __slots__ = ['header','count','num','src']
  _slot_types = ['std_msgs/Header','int32','int32','fdopencv_msgs/ImageMapVal[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ImageMap, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_struct_2i.pack(_x.count, _x.num))
      length = len(self.src)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.count, _x.num,) = _struct_2i.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.src = []
      for i in range(0, length):
        val1 = fdopencv_msgs.msg.ImageMapVal()
        start = end
        end += 4
