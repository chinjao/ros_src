...
if [ $# -eq 0 ]; then
	...
	echo "not argument" 
	echo "hydro or groovy or fuerte or cturtle"
...
ROS_PACKAGE_PATH=${ROS_PACKAGE_PATH}:/opt/ros/hydro/stacks
...
debuild \
 ...
 -e ROS_PACKAGE_PATH=/opt/ros/hydro/share:/opt/ros/hydro/stacks:${HOME}/ros/hark/hark_common_msgs/hark_msgs:${HOME}/ros/hark/hark_common_msgs/hark_params \
 -e LD_LIBRARY_PATH=/opt/ros/hydro/lib
...
# -e PATH=${ROS_ROOT}/bin:${PATH} \
# -e PYTHONPATH=${ROS_ROOT}/core/roslib/src:${PYTHONPATH} \
# -e ROS_PACKAGE_PATH=/opt/ros/cturtle/stacks:`pwd`/../../ROS/ros_stack_hri/hark_common_msgs/hark_msgs:`pwd`/../../ROS/#ros_stack_hri/hark_common_msgs/hark_params
