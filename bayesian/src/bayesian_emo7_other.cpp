...
public:
  void initialize(){
    ...
    emo_to_obserb["happy"]["happy"] = 0.527;
    emo_to_obserb["quiet"]["happy"] = 0.000;
    emo_to_obserb["sad"]["happy"] = 0.016;
    emo_to_obserb["surprise"]["happy"] = 0.032;
    emo_to_obserb["fear"]["happy"] = 0.080;
    emo_to_obserb["disgust"]["happy"] = 0.016;
    emo_to_obserb["angry"]["happy"] = 0.104;

    emo_to_obserb["happy"]["sad"] = 0.073;
    emo_to_obserb["quiet"]["sad"] = 0.026;
    emo_to_obserb["sad"]["sad"] = 0.565;
    emo_to_obserb["surprise"]["sad"] = 0.016;
    emo_to_obserb["fear"]["sad"] = 0.24;
    emo_to_obserb["disgust"]["sad"] = 0.097;
    emo_to_obserb["angry"]["sad"] = 0.060;

    emo_to_obserb["happy"]["normal"] = 0.000;
    emo_to_obserb["quiet"]["normal"] = 0.821;
    emo_to_obserb["sad"]["normal"] = 0.032;
    emo_to_obserb["surprise"]["normal"] = 0.032;
    emo_to_obserb["fear"]["normal"] = 0.040;
    emo_to_obserb["disgust"]["normal"] = 0.048;
    emo_to_obserb["angry"]["normal"] = 0.045;
