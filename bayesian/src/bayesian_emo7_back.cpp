...
public:
  void initialize(){
    ...
    emo_to_obserb["happy"]["joy"] = 0.590;
    emo_to_obserb["quiet"]["joy"] = 0.000;
    emo_to_obserb["sad"]["joy"] = 0.060;
    emo_to_obserb["surprise"]["joy"] = 0.15;
    emo_to_obserb["fear"]["joy"] = 0.089;
    emo_to_obserb["disgust"]["joy"] = 0.038;
    emo_to_obserb["angry"]["joy"] = 0.138;

    emo_to_obserb["happy"]["sadness"] = 0.060;
    emo_to_obserb["quiet"]["sadness"] = 0.000;
    emo_to_obserb["sad"]["sadness"] = 0.488;
    emo_to_obserb["surprise"]["sadness"] = 0.021;
    emo_to_obserb["fear"]["sadness"] = 0.228;
    emo_to_obserb["disgust"]["sadness"] = 0.140;
    emo_to_obserb["angry"]["sadness"] = 0.113;

    emo_to_obserb["happy"]["neutral"] = 0.000;
    emo_to_obserb["quiet"]["neutral"] = 0.795;
    emo_to_obserb["sad"]["neutral"] = 0.048;
    emo_to_obserb["surprise"]["neutral"] = 0.000;
    emo_to_obserb["fear"]["neutral"] = 0.051;
    emo_to_obserb["disgust"]["neutral"] = 0.038;
    emo_to_obserb["angry"]["neutral"] = 0.025;
