...
void emo_and_nameCallback(const speech_msgs::Emotion::ConstPtr& emo_msg){
  ...
  cout << "now" << endl;
  for(int i = 0 ; i < 7 ; i++){
    observation_value[i] = emo_msg->observation_value[i];
  }
  /*
...
private:
  void multiply(){
    ...
    happy = observation_value[3] * emotion_trans["happy"]["happy"] * current_emotion_value[name]["happy"] + observation_value[3] * emotion_trans["quiet"]["happy"] * current_emotion_value[name]["quiet"] + observation_value[3] * emotion_trans["sad"]["happy"] * current_emotion_value[name]["sad"] + observation_value[3] * emotion_trans["surprise"]["happy"] * current_emotion_value[name]["surprise"] + observation_value[3] * emotion_trans["angry"]["happy"] * current_emotion_value[name]["angry"] + observation_value[3] * emotion_trans["fear"]["happy"] * current_emotion_value[name]["fear"] + observation_value[3] * emotion_trans["disgust"]["happy"] * current_emotion_value[name]["disgust"];
  
   
    quiet = observation_value[6] * emotion_trans["happy"]["quiet"] * current_emotion_value[name]["happy"] + observation_value[6] * emotion_trans["quiet"]["quiet"] * current_emotion_value[name]["quiet"] + observation_value[6] * emotion_trans["sad"]["quiet"] * current_emotion_value[name]["sad"] + observation_value[6] * emotion_trans["surprise"]["quiet"] * current_emotion_value[name]["surprise"] + observation_value[3] * emotion_trans["angry"]["quiet"] * current_emotion_value[name]["angry"] +  observation_value[3] * emotion_trans["fear"]["quiet"] * current_emotion_value[name]["fear"] + observation_value[3] * emotion_trans["quiet"]["happy"] * current_emotion_value[name]["disgust"];

    sad = observation_value[4] * emotion_trans["happy"]["sad"] * current_emotion_value[name]["happy"] + observation_value[4] * emotion_trans["quiet"]["sad"] * current_emotion_value[name]["quiet"] + observation_value[4] * emotion_trans["sad"]["sad"] * current_emotion_value[name]["sad"] + observation_value[4] * emotion_trans["surprise"]["sad"] * current_emotion_value[name]["surprise"] + observation_value[4] * emotion_trans["angry"]["sad"] * current_emotion_value[name]["angry"] + observation_value[4] * emotion_trans["fear"]["sad"] * current_emotion_value[name]["fear"] + observation_value[4] * emotion_trans["disgust"]["sad"] * current_emotion_value[name]["disgust"];


    surprise = observation_value[5] * emotion_trans["happy"]["surprise"] * current_emotion_value[name]["happy"] + observation_value[5] * emotion_trans["quiet"]["surprise"] * current_emotion_value[name]["quiet"] + observation_value[5] * emotion_trans["sad"]["surprise"] * current_emotion_value[name]["sad"] + observation_value[5] * emotion_trans["surprise"]["surprise"] * current_emotion_value[name]["surprise"] + observation_value[5] * emotion_trans["angry"]["surprise"] * current_emotion_value[name]["angry"] + observation_value[5] * emotion_trans["fear"]["surprise"] * current_emotion_value[name]["fear"] + observation_value[5] * emotion_trans["disgust"]["surprise"] * current_emotion_value[name]["disgust"];


    angry = observation_value[0] * emotion_trans["happy"]["angry"] * current_emotion_value[name]["happy"] + observation_value[0] * emotion_trans["quiet"]["angry"] * current_emotion_value[name]["quiet"] + observation_value[0] * emotion_trans["sad"]["angry"] * current_emotion_value[name]["sad"] + observation_value[0] * emotion_trans["surprise"]["angry"] * current_emotion_value[name]["surprise"] + observation_value[0] * emotion_trans["angry"]["angry"] * current_emotion_value[name]["angry"] + observation_value[0] * emotion_trans["fear"]["angry"] * current_emotion_value[name]["fear"] + observation_value[0] * emotion_trans["disgust"]["angry"] * current_emotion_value[name]["disgust"];


    fear = observation_value[2] * emotion_trans["happy"]["fear"] * current_emotion_value[name]["happy"] + observation_value[2] * emotion_trans["quiet"]["fear"] * current_emotion_value[name]["quiet"] + observation_value[2] * emotion_trans["sad"]["fear"] * current_emotion_value[name]["sad"] + observation_value[2] * emotion_trans["surprise"]["fear"] * current_emotion_value[name]["surprise"] + observation_value[2] * emotion_trans["angry"]["fear"] * current_emotion_value[name]["angry"] + observation_value[2] * emotion_trans["fear"]["fear"] * current_emotion_value[name]["fear"] + observation_value[2] * emotion_trans["disgust"]["fear"] * current_emotion_value[name]["disgust"];


    disgust = observation_value[1] * emotion_trans["happy"]["disgust"] * current_emotion_value[name]["happy"] + observation_value[1] * emotion_trans["quiet"]["disgust"] * current_emotion_value[name]["quiet"] + observation_value[1] * emotion_trans["sad"]["disgust"] * current_emotion_value[name]["sad"] + observation_value[1] * emotion_trans["surprise"]["disgust"] * current_emotion_value[name]["surprise"] + observation_value[1] * emotion_trans["angry"]["disgust"] * current_emotion_value[name]["angry"] + observation_value[1] * emotion_trans["fear"]["disgust"] * current_emotion_value[name]["fear"] + observation_value[1] * emotion_trans["disgust"]["disgust"] * current_emotion_value[name]["disgust"];
